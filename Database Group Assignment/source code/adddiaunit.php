...
<html lang="en">
  ...
  <nav class="navbar navbar-light bg-light">
    ...
    <h1 class = "text-center">Diagnostic Unit Page</h1>
    <div class="container my-5">
    <form action="adddiaunit.php" method = "POST">
  ...
  <div class="mb-3">
    <label for="name" class="form-label">Diagnostic Unit Name</label>
    <input type="text" class="form-control" placeholder = "Enter Diagnostic Unit Name" name = "unitname">
  </div>
   <div class="mb-3">
...
<?php
  ...
  if(isset($_POST['submit']))
  {
    ...
    $sql4 =  "INSERT INTO diagnostic_unit (Unit_Name,PCU_Id) VALUES ('$unitname','$pcuid')";
