...
<body>
    <nav class="navbar navbar-light bg-light">
      <div class="container">
        ...
        <p class="h3">In Patient Details</p>
      </div>
   </nav>
  ...
  <tbody>
    <?php
     ...
     if($result)
     {
         ...
         {
             $pid = $row['patient_Id'];
             $atime = $row['Admitted_Time'];
             $adate = $row['Admitted_Date'];
             $dtime = $row['Discharged_Time'];
             $ddate = $row['Discharged_Date'];
             $wardno = $row['Ward_No'];
             echo '<tr>
             <th scope="row">'.$pid.'</th>
             <td>'.$atime.'</td>
...
<a href="displayemergency.php"><button type="btn" class="btn btn-primary">Next</button></a>
    </div>
</body>
</html>