...
<html lang="en">
  ...
  <nav class="navbar navbar-light bg-light">
      <div class="container">
        <a class="navbar-brand" href="inpatient.php">
    ...
    <form action="patientec.php" method = "POST">
  ...
  <input class="form-check-input " type="radio" name="insurance" id="flexRadioDefault1" VALUE="true">
  <label class="form-check-label" for="flexRadioDefault1">
    With Insurance
  </label>
</div>
<div class="form-check">
  <input class="form-check-input ms-3" type="radio" name="insurance" id="flexRadioDefault2" VALUE="false" checked>
